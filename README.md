...
* Добавлено автоматическое ежедневное обновление доступных способов оплаты Robokassa через WP-Cron
* Добавлен бейдж оплаты частями в каталог товаров с настройками отображения, размера и темы
* Исправлена фискализация для продавцов из Казахстана: список ставок НДС теперь зависит от страны магазина
* Исправлена логика передачи СНО и ставок НДС: для Казахстана не передается СНО
* Добавлена поддержка ставки НДС 16% для клиентов из Казахстана

= 1.8.5 =
* Добавлен новый способ оплаты "Оплата через QR-код СБП"
* Добавлен функционал выбора предмета расчета для конкретного товара
* Добавлен редирект при закрытии iFrame без оплаты
