			...
			<div class="main-settings">
				<div class="robokassa-card robokassa-card--compact">
					...
					<table class="robokassa-form-table robokassa-info-table">
						<tr>
							...
							<td>
								<code id="ResultURL" class="robokassa-code"><?php echo Util::siteUrl('/?robokassa=result'); ?></code>
							</td>
							<td>
								<button class="robokassa-button-primary btn btn-default btn-clipboard btn-main" data-clipboard-target="#ResultURL" onclick="event.preventDefault();">
									Скопировать
								</button>
							</td>
						</tr>
						<tr>
							...
							<td>
								<code id="SuccessURL" class="robokassa-code"><?php echo Util::siteUrl('/?robokassa=success'); ?></code>
							</td>
							<td>
								<button class="robokassa-button-primary btn btn-default btn-clipboard btn-main" data-clipboard-target="#SuccessURL" onclick="event.preventDefault();">
									Скопировать
								</button>
							</td>
						</tr>
						<tr>
							...
							<td>
								<code id="FailURL" class="robokassa-code"><?php echo Util::siteUrl('/?robokassa=fail'); ?></code>
							</td>
							<td>
								<button class="robokassa-button-primary btn btn-default btn-clipboard btn-main" data-clipboard-target="#FailURL" onclick="event.preventDefault();">
									Скопировать
								</button>
							</td>
						</tr>
				...
				<div class="robokassa-card">
                    ...
                    <td>
								...
								<table class="robokassa-form-table form-table">
									<?php foreach ($optional_methods as $config) :
										...
										<tr valign="top">
											...
											<td>
												<input type="hidden" name="<?php echo esc_attr($option_name); ?>" value="<?php echo esc_attr($hidden_value); ?>"/>

												<?php if ($is_available) : ?>
													<label for="<?php echo esc_attr($field_id); ?>">
														<input type="checkbox" id="<?php echo esc_attr($field_id); ?>" name="<?php echo esc_attr($option_name); ?>" value="yes" <?php checked($is_enabled); ?>/>
														<span>Отображать способ оплаты</span>
													</label>
												<?php else : ?>
													<label>
														<input type="checkbox" <?php checked($is_enabled); ?> disabled="disabled"/>
														<span>Отображать способ оплаты</span>
													</label>
												<?php endif; ?>
											</td>
						...
						<h2 class="robokassa-card__title">Общие настройки</h2>
						...
						<p class="submit">
							<input type="submit" class="robokassa-button-primary btn btn-default btn-clipboard btn-main" value="<?php _e('Save Changes') ?>"/>
						</p>
