...
<div class="robokassa-admin-wrapper">
	<div class="robokassa-admin-container">
		<div class="robokassa-card sms-settings">
			...
			<p class="robokassa-card__description">Управляйте текстами и условиями отправки SMS-сообщений для покупателей вашего магазина.</p>
			...
			<form method="post" action="options.php">
				...
				<table class="robokassa-form-table form-table">
					...
					<tr valign="top">
						...
						<td>
							<input type="checkbox" id="sms2_enabled" name="robokassa_payment_sms2_enabled" <?php echo get_option('robokassa_payment_sms2_enabled') == 'on' ? 'checked="checked"' : ''; ?> onchange="robokassa_payment_refresher();"><label for="sms2_enabled">Включить/Выключить</label>
						</td>
					</tr>
